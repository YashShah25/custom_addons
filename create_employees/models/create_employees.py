...
class CreateEmployees(models.Model):
    ...
    job_position_id = fields.Many2one('hr.job', string=_("Job Position"), required=True, tracking=True)
    affordable_salary = fields.Float(related="job_position_id.affordable_salary", string=_("Affordable Salary"))
