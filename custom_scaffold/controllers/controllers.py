...
class Controller(http.Controller):
    ...
    @http.route(
        '/custom_scafold/custom_scafold/objects/<model("custom_scafold.custom_scafold"):obj>/',
        auth="public",
    )
    def object(self, obj, **kw):
        return http.request.render("custom_scafold.object", {"object": obj})
