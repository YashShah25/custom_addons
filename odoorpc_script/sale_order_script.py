...
odoo.login('odoorpc_db', 'admin', 'admin')

start_time = datetime.now()

with open('/home/odoo/Odoo_Workspace/custom_addons/odoorpc_script/sale_order.csv') as csv_file:
...
with open('/home/odoo/Odoo_Workspace/custom_addons/odoorpc_script/sale_order_line.csv') as csv_file:
    csv_file = csv.DictReader(csv_file)
    excel_row_line = 2
    for row in csv_file:
        rec = dict(row)
